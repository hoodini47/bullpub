...
`)
  ...
  <div role="button" tabIndex={0} id={`bullpub-mini-logo`} onClick={() => {
  ...
  <nav className={`desktop-main-nav`}>
    ...
    <nav className={`desktop-side-nav`}>
      ...
      <div id="social-media-icons">
          <a tabIndex={0} href="https://pl.tripadvisor.com/Restaurant_Review-g274772-d1123070-Reviews-Bull_Pub-Krakow_Lesser_Poland_Province_Southern_Poland.html">
          <TripAdvisorLogo />
          </a>
          <a tabIndex={0} href="https://www.facebook.com/bullpubcracow/">
            <FaFacebook />
          </a>
      </div>
    </nav>
